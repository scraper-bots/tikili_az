...
def real_finetune():
    ...
    # Set up optimizer (using torch.optim instead)
    ...
    for epoch in range(num_epochs):
        ...
        # Simple loop instead of tqdm for better compatibility
        for i, batch_tokens in enumerate(tokenized_texts):
            # Move to device
            ...
            # Print progress
            if i % 5 == 0:
                print(f"  Step {i+1}/{len(tokenized_texts)}, Loss: {loss.item():.4f}")
